...
var svg_2_ent = d3.select(".entropy_cos_heatmap")
.append("svg")
...
//Read the data
d3.csv("Table/csv_cossim_entropy_2gram.csv", function(data) {
  ...
  var tooltip = d3.select(".entropy_cos_heatmap")
		.append("div")
		.attr('class', 'tooltip');
  ...
  svg_2_ent.selectAll()
    ...
    .on("mouseover", function(d) {
	  ...
	  .style("stroke-width", 2.5)
			return tooltip.style("visibility", "visible").text(d.doc_b + " : " + d.doc_a +" = "+ d.value);})
