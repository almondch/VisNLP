...
var svg_3_ent = d3.select(".entropy_heatmap3")
.append("svg")
...
//Read the data
d3.csv("Table/csv_heat_entropy_trigram.csv", function(data) {
  ...
  var tooltip = d3.select(".entropy_heatmap3")
		.append("div")
		.attr('class', 'tooltip');
  ...
  svg_3_ent.selectAll()
    ...
    .on("mouseover", function(d) {
	  ...
	  .style("stroke-width", 2.5)
			return tooltip.style("visibility", "visible").text(d.word+" : "+d.doc +" = "+ d.value);})
