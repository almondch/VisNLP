d3.json("/Entropy/entropy_step4_unigram.json", function(data) {
	...
	var svg = d3.select("#entropy_step4").append("svg")
	...
	var tooltip = d3.select("#entropy_step4")
		.append("div")
		.attr('class', 'tooltip');
	...
	node.append("text")
		...
		.on("mouseout", function(d) {
			return d3.select(this).style("fill", function(d) { return d.children || d._children ? "white": "black";}).style("font-weight", "normal")});
